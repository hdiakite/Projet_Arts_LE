        ...
        <div>
                <Menu className="nenuGeneral" onClick={handleClick} selectedKeys={[current]} mode="horizontal" style={centerStyle}>
                    ...
                    <Menu.Item key="demandeVierge">
                            <Link to="/ProgramTechnicien/ProgramLancerEssai" style={{color:'white'}}> Je suis demandeur </Link>
                    </Menu.Item>
                    <Menu.Item key="program">
                        <Link to="/ProgramTechnicien/Program/ProgramEssai" style={{color:'white'}}>Programme</Link>
                    </Menu.Item>
                    <Menu.Item key="recherche">
                        <Link to="/RechercheGlobale" style={{color:'white'}}>Recherche globale</Link>
                    </Menu.Item>
                    <Menu.Item key="recherche">
                        <Link to="/ProgramTechnicien/ProgramEssaiEnCours" style={{color:'white'}}>Essai en cours</Link>
                    </Menu.Item>
                </Menu>
            </div>          
            <Switch>
                <Route path="/ProgramTechnicien/Program/ProgramEssai" component = {ProgramEssai}/>
                <Route path="/MesDemandes" component = {MesDemandes }/>
                <Route path="/RechercheGlobale" component = {RechercheGlobale}/>
                <Route path="/ProgramTechnicien/ProgramLancerEssai" component = {ProgramLancerEssai}/>
                <Route path="/ProgramTechnicien/ProgramEssaiEnCours" component = {ProgramEssaiEnCours}/>
