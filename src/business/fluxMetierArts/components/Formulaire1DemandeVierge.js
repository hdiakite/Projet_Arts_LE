...
function Formulaire1DemandeVierge() {
    ...
    return (
        ...
        <Form {...layout} id="demande" className="formulaireDemande1" name="dynamic_form_nest_item" onFinish={onFinish} autoComplete="off" layout="vertical">
            <Form.Item className="labelTextArea" name={[ 'OjetEssai']} label="Objet de l'essai">
                <Input.TextArea id="objetEssai" showCount maxLength={100}/>
            </Form.Item>
            ...
            <Form.Item  className="label1" name="categorie" label="Catégorie" rules={[{ required: true }]}>
                <Input id="categorie"defaultValue={props.name}/>
            </Form.Item>
            <Form.Item  className="label1" name="priorite" label="Priorité" rules={[{ required: true }]}>
                <Select>
                    <Select.Option id="priorite" value="prioriete"> priorite </Select.Option>
                </Select>
            </Form.Item>
            <Form.Item  className="label1" name="dateMaxLancement" label="Date max de lancement">
                <DatePicker id="dateMaxLancement" style={{ width:200}}/>
            </Form.Item>
            ...
            <Form.Item  className="label1" name="numeroProjet" label="Numero de projet" rules={[{ required: true }]}>
                <Input id = "numProjet" placeholder="1234"/>
            </Form.Item>
