...
import { Form, Select, Tabs, Table, Space, Tag, PageHeader } from 'antd';
import './style.css';
      ...
      <div className="dimansionDemandeEssai">
        ...
        >
          ...
          <Tabs defaultActiveKey="1" className="positionTabs" layout="inline">
            <TabPane tab="Tous 0" key="1"></TabPane>
            <TabPane tab="Brouillons 0" key="2"></TabPane>
            <TabPane tab="En attente de validation 0" key="3"></TabPane>
            <TabPane tab="En attente de traitement 0" key="4"></TabPane>
            <TabPane tab="En cours 0" key="5"></TabPane>
            <TabPane tab="Terminés 0" key="6"></TabPane>
          </Tabs>

          <Form.Item
            className=" labelDemandesEssais"
            name="demandeur"
            label="Demandeur"
          >
            <Select placeholder="Select demandeur" style={{ width: 160 }}>
              <Option value="demandeur">demandeur</Option>
            </Select>
          </Form.Item>
          <Form.Item className="" name="technicien" label="Technicien">
            <Select placeholder="Select Technicien" style={{ width: 160 }}>
        ...
        <div className="tableauMesDemande">
          <Table dataSource={data}>
            ...
            <Column
              ...
              render={(statut) => (
                <>
                  {statut.map((statuItem) => (
                    <Tag color="blue" key={statuItem}>
                      {statuItem}
                    </Tag>
                  ))}
                </>
