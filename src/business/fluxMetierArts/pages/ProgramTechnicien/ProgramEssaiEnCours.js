...
const ProgramEssaiEnCours = () => {
    ...
    return (
        <div className="dimensionPage">
               ...
               <Tag style={{display:'inline-block',width:80,textAlign:'center', marginLeft:15}}color="blue">En cours </Tag> 
                    <SaisieDonneeDeMesure/>
                    <br/>
                    <Button className="ButtonAnuller">Annuler</Button>
                    <Button className="ButtonEnregistrer">Enregitrer</Button>
                    <Button className="ButtonTerminer" type="primary"  onClick={showConfirm}>Terminer</Button>
        </div>     
    );
}
