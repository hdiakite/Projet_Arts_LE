...
{/*------------------Formulaire recherche --------------------------------------------*/}
        ...
        <Form  className="dimensionFormulaire" name="dynamic_form_nest_item" onFinish={onFinish} autoComplete="off" layout="vertical">
                <Form.Item className="labelInputRecherche " name="filtre" label="Filtrer par">
                    <Select
                    placeholder="Select " style={{width:200}}
                    >
                        <Option value="">filtre</Option>
                    </Select>
                </Form.Item>
                <Form.Item className="labelInputRecherche" name="recherche" label="Recherche">
                    <Select
                    placeholder="Select " style={{width:200}}
                    >
                ...
                <Form.Item className="buttontRecherche" name="recherche">
                    <Button style={{width:150}}type="primary" icon={<SearchOutlined />}>
                         Search
                    </Button>
                </Form.Item>
            </Form>
{/*-----------------------------------------------------Tableau resultat recherche------------------------------------------------------*/ }
            <Divider orientation="left" style={{opacity:0.23}}>Resultat de la recherche</Divider>
